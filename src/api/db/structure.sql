...
CREATE TABLE `vanity_conversions` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `vanity_experiment_id` int(11) DEFAULT NULL,
  `alternative` int(11) DEFAULT NULL,
  `conversions` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `by_experiment_id_and_alternative` (`vanity_experiment_id`,`alternative`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `vanity_experiments` (
  ...
  PRIMARY KEY (`id`),
  KEY `index_vanity_experiments_on_experiment_id` (`experiment_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

CREATE TABLE `vanity_metric_values` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `vanity_metric_id` int(11) DEFAULT NULL,
  `index` int(11) DEFAULT NULL,
  `value` int(11) DEFAULT NULL,
  `date` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `index_vanity_metric_values_on_vanity_metric_id_and_date` (`vanity_metric_id`,`date`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `vanity_metrics` (
  ...
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `index_vanity_metrics_on_metric_id` (`metric_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `vanity_participants` (
  ...
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `index_vanity_participants_on_experiment_id` (`experiment_id`),
  KEY `by_experiment_id_and_identity` (`experiment_id`,`identity`),
  KEY `by_experiment_id_and_shown` (`experiment_id`,`shown`),
  KEY `by_experiment_id_and_seen` (`experiment_id`,`seen`),
  KEY `by_experiment_id_and_converted` (`experiment_id`,`converted`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
